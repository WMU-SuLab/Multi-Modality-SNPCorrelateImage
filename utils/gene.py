...
def handle_gene_file(gene_file_path, gene_freq: list[dict] = None, normalization: bool = True) -> torch.Tensor:
    ...
    if gene_freq:
        ...
        gene_data = torch.tensor([gene for gene in freq_gene_data], dtype=torch.float32)
    else:
